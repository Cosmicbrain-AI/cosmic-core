...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "CosmicBrain powers the data and deployment stack behind humanoids." },
      ...
      { property: "og:description", content: "CosmicBrain powers the data and deployment stack behind humanoids." },
      ...
      { name: "twitter:description", content: "CosmicBrain powers the data and deployment stack behind humanoids." },
